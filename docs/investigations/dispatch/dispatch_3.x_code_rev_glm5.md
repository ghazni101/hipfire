> **Lifecycle:** historical investigation record (archived).
> **Authority:** discovery / dated field notes only — not live product surface.
> **Provenance:** moved from root `findings/dispatch_3.x_code_rev_glm5.md` during repository-organization cleanup (2026-08).
> **Subject:** Dispatch 3.x adversarial code review (GLM-5).
