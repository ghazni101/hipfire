...
> **Provenance:** moved from root `findings/dispatch_3.1_dev_log.md` during repository-organization cleanup (2026-08).
> **Subject:** Ship 3.1 attention-decode wire-up dev log.
