...
> **Provenance:** moved from root `findings/gfx906_regression_dispatch.md` during repository-organization cleanup (2026-08).
> **Subject:** gfx906 regression dispatch investigation.
