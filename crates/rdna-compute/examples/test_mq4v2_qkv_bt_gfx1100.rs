...
//! MQ4V2 qkv BT parity on exact gfx1100 — batch-column reuse gate.
//!
...
//! 8-row final tile) so straddling tiles and tail guards are exercised. On exact
//! gfx1100:
...
//!   2) run the direct `gemm_qkv_mq4g256v2_wmma_gfx1100_bt` launchers into
...
fn main() {
    ...
    eprintln!("arch {arch} confirmed exact gfx1100 — running qkv BT parity");
    ...
    for &n in &ns {
        ...
        for &bt in &bts {
            ...
            let res = gpu.gemm_qkv_mq4g256v2_wmma_gfx1100_bt(
            ...
            if n == 256 {
                ...
                gpu.gemm_qkv_mq4g256v2_wmma_gfx1100_bt(
